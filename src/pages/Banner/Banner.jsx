  ...
  return (
    <div className=''>
      <div className='bg-PrimaryBg '>
        <div className='relative container mx-auto pt-10 pb-32 border-4'>
          <div className="">
            <p className="absolute top-56 left-0 text-2xl rotate-90 font-semibold">2024  EDITION</p>
            <div className="">
              ...
              <div className="border-l-4 border-black pl-4 py-2 absolute left-96 bottom-36">
            ...
            <div className="">
              ...
              <h3 className="text-[131px] text-[#FF6F00] font-MochiyPopOne absolute bottom-32 right-56">arrivals</h3>
            </div>
            <div className="">

              <h3 className="absolute top-52 right-80 text-6xl text-white font-MochiyPopOne rotate-90 font-semibold">2024</h3>
              <p className="absolute -bottom-10 right-0 text-2xl rotate-90 font-semibold">2024  EDITION</p>
            </div>
          </div>
        </div>
